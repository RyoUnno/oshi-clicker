...
export const voiceAssets = {
  /** タップ時（低確率で再生） */
  tap: [
    "/assets/voices/tap_01.mp3",
    "/assets/voices/tap_02.mp3"
  ],
  /** 衣装解放時 */
  unlock: [
    "/assets/voices/unlock_01.mp3"
  ],
  /** アップグレード購入時 */
  upgrade: [
    "/assets/voices/upgrade_01.mp3",
    "/assets/voices/upgrade_02.mp3"
  ],
  /** 衣装切り替え時 */
  costume: [
    "/assets/voices/costume_01.mp3",
    "/assets/voices/costume_02.mp3"
  ],
  /** アイドル（10〜30秒ごとにランダム発話） */
  idle: [
    "/assets/voices/idle_01.mp3",
    "/assets/voices/idle_02.mp3",
    "/assets/voices/idle_03.mp3"
  ]
} as const;
